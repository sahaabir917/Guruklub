...
import com.gmpire.guruklub.databinding.ItemMyFriendBinding
import com.gmpire.guruklub.view.adapter.IAdapterListener
import com.gmpire.guruklub.view.base.BaseViewHolder
import com.google.firebase.crashlytics.internal.model.CrashlyticsReport

class MyFriendViewHolder(itemView: ViewDataBinding,
                                 context: Context?): BaseViewHolder(itemView.root) {

    var binding = itemView as ItemMyFriendBinding
    ...
    override fun <T> onBind(position: Int, itemModel: T, listener: IAdapterListener) {
        ...
        binding.playBtn.setOnClickListener{
            listener.callBack(position,itemModel,binding.playBtn)
        }
